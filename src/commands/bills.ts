...
export class BillsGetCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    `,
    examples: [
      ['Get current month billing', 'transloadify bills get'],
      ['Get specific month', 'transloadify bills get 2024-01'],
      ['Get multiple months', 'transloadify bills get 2024-01 2024-02'],
    ],
  })
