...
export class NotificationsReplayCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [
      ['Replay notifications', 'transloadify assembly-notifications replay ASSEMBLY_ID'],
      [
        'Replay to a new URL',
        'transloadify assembly-notifications replay --notify-url https://example.com/notify ASSEMBLY_ID',
      ],
    ],
  })
...
export class NotificationsListCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    `,
    examples: [
      ['List all notifications', 'transloadify assembly-notifications list'],
      ['List failed notifications', 'transloadify assembly-notifications list --failed'],
      ['List for specific assembly', 'transloadify assembly-notifications list ASSEMBLY_ID'],
    ],
  })
