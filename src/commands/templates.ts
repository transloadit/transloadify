...
export class TemplatesCreateCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    `,
    examples: [
      ['Create template from file', 'transloadify templates create my-template steps.json'],
      ['Create template from stdin', 'cat steps.json | transloadify templates create my-template'],
    ],
  })
...
export class TemplatesGetCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [['Get a template', 'transloadify templates get TEMPLATE_ID']],
  })
...
export class TemplatesModifyCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    `,
    examples: [
      ['Modify template from file', 'transloadify templates modify TEMPLATE_ID steps.json'],
      ['Rename a template', 'transloadify templates modify --name new-name TEMPLATE_ID'],
    ],
  })
...
export class TemplatesDeleteCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [['Delete a template', 'transloadify templates delete TEMPLATE_ID']],
  })
...
export class TemplatesListCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [
      ['List all templates', 'transloadify templates list'],
      ['List templates sorted by name', 'transloadify templates list --sort name'],
    ],
  })
...
export class TemplatesSyncCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    `,
    examples: [
      ['Sync templates in a directory', 'transloadify templates sync templates/'],
      ['Sync recursively', 'transloadify templates sync --recursive templates/'],
    ],
  })
