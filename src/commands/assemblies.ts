  ...
  static override usage = Command.Usage({
    ...
    examples: [
      [
        ...
        'transloadify assemblies create --steps steps.json -i input.jpg -o output.jpg',
      ],
      [
        'Process with a template',
        'transloadify assemblies create --template TEMPLATE_ID -i input.jpg -o output/',
      ],
      [
        'Watch for changes',
        'transloadify assemblies create --steps steps.json -i input/ -o output/ --watch',
      ],
    ],
  })
...
export class AssembliesListCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [
      ['List recent assemblies', 'transloadify assemblies list'],
      ['List assemblies after a date', 'transloadify assemblies list --after 2024-01-01'],
    ],
  })
...
export class AssembliesGetCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [['Get assembly status', 'transloadify assemblies get ASSEMBLY_ID']],
  })
...
export class AssembliesDeleteCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [['Cancel an assembly', 'transloadify assemblies delete ASSEMBLY_ID']],
  })
...
export class AssembliesReplayCommand extends AuthenticatedCommand {
  ...
  static override usage = Command.Usage({
    ...
    examples: [
      ['Replay an assembly', 'transloadify assemblies replay ASSEMBLY_ID'],
      [
        'Replay with new notify URL',
        'transloadify assemblies replay --notify-url https://example.com/notify ASSEMBLY_ID',
      ],
    ],
  })
