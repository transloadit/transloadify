  ...
  describe('parse', () => {
    it('should handle typical cli edge-cases', () => {
      ...
      const tests = [
        ...
        { args: '-r file.txt', opts: [{ recursive: null }], tgts: ['file.txt'] },

        { args: '--file file.txt', opts: [{ file: 'file.txt' }], tgts: [] },
        { args: '--file=file.txt', opts: [{ file: 'file.txt' }], tgts: [] },
        { args: '-f file.txt', opts: [{ file: 'file.txt' }], tgts: [] },
        { args: '-ffile.txt', opts: [{ file: 'file.txt' }], tgts: [] },

        { args: '--recursive=invalid.txt', fail: 'UNNECESSARY_ARGUMENT' },
        { args: '-rinvalid.txt', fail: 'INVALID_OPTION' },

        { args: '--invalid', fail: 'INVALID_OPTION' },
        { args: '-i', fail: 'INVALID_OPTION' },
        ...
        { args: '-r -', opts: [{ recursive: null }], tgts: ['-'] },
        { args: '-f -', opts: [{ file: '-' }], tgts: [] },
        { args: '-f -- -r', opts: [{ file: '--' }, { recursive: null }], tgts: [] },
        ...
        { args: 'templates', cmds: { mode: 'templates' }, opts: [], tgts: [] },
        { args: 'a create', cmds: { mode: 'assemblies', action: 'create' }, opts: [], tgts: [] },
        {
...
describe('Cli', () => {
  it('should validate and interpret arguments appropriately', () => {
    const tests = [
      ...
      { args: 'register --watch', rslt: { error: 'INVALID_OPTION' } },
      ...
      },
      {
        ...
        rslt: { mode: 'assemblies', action: 'create', steps: 'steps.json' },
      },
      {
        args: '--template 5',
        rslt: { mode: 'assemblies', action: 'create', template: '5', steps: false },
      },
      { args: '-t5 --watch', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: '-t5 --watch -ia', rslt: { watch: true } },
      { args: '-t5 --recursive', rslt: { recursive: true } },
      {
        args: '-t5 -ffoo=bar=baz -fa=b -fc=d',
        rslt: { fields: { foo: 'bar=baz', a: 'b', c: 'd' } },
      },
      { args: '-t5 -ia -ib -oc', rslt: { inputs: ['a', 'b'], output: 'c' } },
      { args: 'assemblies create', rslt: { error: 'INVALID_OPTION' } },
      { args: '--template 5 --steps steps.json', rslt: { error: 'INVALID_OPTION' } },
      { args: '-t5 -oa -ob', rslt: { error: 'INVALID_OPTION' } },
      ...
      { args: 'assemblies list -b 2016-09-11', rslt: { before: '2016-09-11' } },
      { args: 'assemblies list -a 2016-09-11', rslt: { after: '2016-09-11' } },
      {
        args: 'assemblies list --keywords=foo,bar --keywords=baz,qux',
        rslt: { keywords: ['foo', 'bar', 'baz', 'qux'] },
      },
      { args: 'assemblies list --fields foo,bar', reslt: { fields: ['foo', 'bar'] } },
      { args: 'assemblies list -a 2016-09-11 -a 2016-09-12', rslt: { error: 'INVALID_OPTION' } },
      {
...

      {
        ...
        rslt: { mode: 'assemblies', action: 'get', assemblies: ['a', 'b', 'c'] },
      },
      { args: 'assemblies get', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: 'assemblies get --recursive', rslt: { error: 'INVALID_OPTION' } },

      {
        args: 'assemblies delete a b c',
        rslt: { mode: 'assemblies', action: 'delete', assemblies: ['a', 'b', 'c'] },
      },
      { args: 'assemblies delete', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: 'assemblies delete --recursive', rslt: { error: 'INVALID_OPTION' } },
      ...
      { args: 'assemblies replay --reparse-template a', rslt: { reparse: true } },
      { args: 'assemblies replay -fa=b a', rslt: { fields: { a: 'b' } } },
      { args: 'assemblies replay', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: 'assemblies replay --recursive', rslt: { error: 'INVALID_OPTION' } },

      {
        args: 'templates create foo',
        rslt: { mode: 'templates', action: 'create', name: 'foo', file: '-' },
      },
      { args: 'templates create foo steps.json', rslt: { name: 'foo', file: 'steps.json' } },
      { args: 'templates create', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: 'templates create a b c', rslt: { error: 'INVALID_ARGUMENT' } },

      { args: 'templates get a', rslt: { mode: 'templates', action: 'get', templates: ['a'] } },
      { args: 'templates get a b', rslt: { templates: ['a', 'b'] } },
      { args: 'templates get', rslt: { error: 'MISSING_ARGUMENT' } },

      {
        args: 'templates modify foo',
        rslt: { mode: 'templates', action: 'modify', template: 'foo', name: undefined, file: '-' },
      },
      { args: 'templates modify foo steps.json', rslt: { template: 'foo', file: 'steps.json' } },
      {
        args: 'templates modify foo -n bar steps.json',
        rslt: { template: 'foo', name: 'bar', file: 'steps.json' },
      },
      { args: 'templates modify', rslt: { error: 'MISSING_ARGUMENT' } },
      { args: 'templates modify a b c', rslt: { error: 'INVALID_ARGUMENT' } },

      {
        args: 'templates delete a',
        rslt: { mode: 'templates', action: 'delete', templates: ['a'] },
      },
      { args: 'templates delete a b', rslt: { templates: ['a', 'b'] } },
      { args: 'templates delete', rslt: { error: 'MISSING_ARGUMENT' } },
      ...
      },
      {
        ...
        rslt: { before: '2016-09-13', after: '2015-09-13' },
      },
      { args: 'templates list --fields id,created', rslt: { fields: ['id', 'created'] } },
      { args: 'templates list --order=asc', rslt: { order: 'asc' } },
      { args: 'templates list --order=invalid', rslt: { error: 'INVALID_OPTION' } },
      { args: 'templates list --sort=name', rslt: { sort: 'name' } },
      { args: 'templates list --sort=invalid', rslt: { error: 'INVALID_OPTION' } },
      ...
      { args: 'bills get 2016-08 2016-07', rslt: { months: ['2016-08', '2016-07'] } },
