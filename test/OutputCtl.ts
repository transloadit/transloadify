 ...
 * instead of writing to console. Implements the same interface as src/OutputCtl.
 */
export default class OutputCtl {
  private output: OutputEntry[]
  // These properties are required by the src/OutputCtl interface but not used in tests
